           ...
           className='about-img'
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                exploration, and baseball. In my spare time, I am dabbling in
                electronics repair/ customization and watching/playing Baseball.
              </Card.Text>
              <Card.Footer>
        ...
        <Col md={3}>
          <Card className='biocard'>
            ...
            <Card.Body>
              ...
              <Card.Text>
                As an aspiring software engineer, I love to code and solve
                challenging problems. I'm currently perfecting my skills and am
                training to become a software engineer to solve real-world
                problems. When I'm not coding, I enjoy drawing and listening to
                music.
              </Card.Text>
              <Card.Footer>
          ...
          <Card className='biocard'>
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                Computer Engineering Technology from The New York City College
                of Technology. When I'm not coding, I enjoy spending time with
                my family, playing games, and watching different series.
              </Card.Text>
              <Card.Footer>
